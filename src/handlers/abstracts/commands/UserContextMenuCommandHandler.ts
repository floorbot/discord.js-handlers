...
export abstract class UserContextMenuCommandHandler extends ApplicationCommandHandler<UserContextMenuInteraction, UserApplicationCommandData> {
     ...
     */
    public abstract override run(contextMenu: UserContextMenuInteraction): Promise<void>;
}
