...
export abstract class MessageContextMenuCommandHandler extends ApplicationCommandHandler<MessageContextMenuCommandInteraction, MessageApplicationCommandData> {
     ...
     */
    public abstract override run(contextMenu: MessageContextMenuCommandInteraction): Promise<void>;
}
