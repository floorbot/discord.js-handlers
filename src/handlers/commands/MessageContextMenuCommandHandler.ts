...
import { ContextMenuCommandHandler } from './ContextMenuCommandHandler.js';

export abstract class MessageContextMenuCommandHandler extends ContextMenuCommandHandler<MessageContextMenuCommandInteraction, ContextMenuCommandBuilder> {
